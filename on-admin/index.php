  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ...
        <small>PT. Mora Telematika Indonesia</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-PT. Pandu Anugerah Analitika"></i> Home</a></li>
        <li class="active">PT. Mora Telematika Indonesia</li>
      </ol>
    </section>
   ...
   <!-- Main content -->
      ...
      <footer class="main-footer">
        <div class="pull-right hidden-xs">
          <b>PT. Mora Telematika Indonesia </b>2021
        </div>
